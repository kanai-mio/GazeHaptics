...
namespace AudioStream
{
    ...
    /// Abstract base with passthru DSP to capture decoder for components which don't play directly via FMOD only, for interop with Unity audio
    /// </summary>
    public abstract partial class AudioStreamBase : ABase
    {
        ...
        /*
         * DSP callbacks
         * due to IL2CPP not supporting marshaling delegates that point to instance methods to native code we need to circumvent this via static callback
         */
