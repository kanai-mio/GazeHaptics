...
namespace AudioStream
{
    ...
    public static partial class FMOD_SystemW
    {
        ...
        public partial class FMOD_System
        {
            ...
            static FMOD.RESULT PCMReadCallback(System.IntPtr soundraw, System.IntPtr data, uint datalen)
            {
                lock (FMOD_System.pcm_callback_lock)
                {
                    ...
                    if (FMOD_System.pcmCallbackBuffers.TryGetValue(soundraw, out var pcmCallbackBuffer))
                    {
                        ...
                        pcmCallbackBuffer.underflow = av < datalen;
                    }
                }
            ...
            /// 
            // TODO: remove latency
            public (FMOD.Sound, FMOD.Channel) CreateAndPlaySound(int soundSampleRate
                , int soundChannels
                , int latency
                , LogLevel logLevel
                ...
                )
            {
                 ...
                 * setup FMOD callback:
                 * 
                 * the created sound should match current Unity audio -
                 ...
                 *  )
                 * createSound also calls back immediately once after it is created
                 */
                ...
                result = this.system.createSound(String.Empty
                        , FMOD.MODE.OPENUSER
                ...
                FMOD_System.pcmCallbackBuffers.Add(sound.handle, pcmCallbackBuffer);
        ...
        /// </summary>
        public struct OUTPUT_DEVICE_INFO
        {
            public int id;
            public string name;
            public System.Guid guid;
            /// <summary>
            /// driver capabilities - DO NOT USE for sounds of a system - they can differ from its sw format
            /// (ex. getSoftwareFormat: 48000 while getDriverInfo: 44100 && Unity: 48000)
            /// </summary>
            public int samplerate_driver;
            public FMOD.SPEAKERMODE speakermode_driver;
            public int channels_driver;
        }
        /// <summary>
        ...
        /// <param name="onError"></param>
        /// <returns></returns>
        public static List<OUTPUT_DEVICE_INFO> AvailableOutputs(LogLevel logLevel
            , string gameObjectName
            , EventWithStringStringParameter onError
            )
        {
            ...
            List<OUTPUT_DEVICE_INFO> availableDrivers = new List<OUTPUT_DEVICE_INFO>();
            ...
            for (int i = 0; i < numDrivers; ++i)
            {
                ...
                availableDrivers.Add(new OUTPUT_DEVICE_INFO() { id = i, name = name, guid = guid, samplerate_driver = systemrate, speakermode_driver = speakermode, channels_driver = speakermodechannels });
