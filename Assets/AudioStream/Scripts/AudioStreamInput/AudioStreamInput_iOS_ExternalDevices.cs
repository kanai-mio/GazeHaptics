...
namespace AudioStream
{
    ...
    /// </summary>
    public class AudioStreamInput_iOS_ExternalDevices : ABase
    {
        // ========================================================================================================================================
        #region Editor
        ...
        {
            // adjust requested byte size to what's available
            len = (uint)Mathf.Min(len, this.outputBuffer.Available());
        ...
        void OnAudioFilterRead(float[] data, int channels)
        {
            ...
            if (inputSignal_length > 0)
            {
                ...
                else
                {
                    ...
                    var length = (uint)Mathf.Min(dlength, this.oafrOutputBuffer.Available());
