    ...
    public class AVAudioSessionWrapper
    {
...
#else
            {
                Log.LOG(LogLevel.DEBUG, LogLevel.DEBUG, "AVAudioSessionWrapper", "UpdateAVAudioSession bluetoothRecording: {0}, defaultToSpeaker {1}", bluetoothRecording, defaultToSpeaker);
            }
#endif
        }
        ...
        public static string[] AvailableInputs()
        {
#if UNITY_IOS && !UNITY_EDITOR
            {
                ...
                var result = AudioStreamSupport.StringHelper.PtrToStringArray(icount, ptrs);
        ...
        public static string[] AvailableOutputs()
        {
#if UNITY_IOS && !UNITY_EDITOR
            {
                ...
                var result = AudioStreamSupport.StringHelper.PtrToStringArray(ocount, ptrs);
...
#else
            {
                Log.LOG(LogLevel.DEBUG, LogLevel.DEBUG, "AVAudioSessionWrapper", "SetPreferredInput input: {0}", input);
            }
#endif
        }
        ...
        public static void StartRecording()
        {
            ...
            {
                isRecording = true;
                Log.LOG(LogLevel.DEBUG, LogLevel.DEBUG, "AVAudioSessionWrapper", "StartRecording");
            }
#endif
        }
        ...
        public static void StopRecording()
        {
...
#else
            {
                ...
                Log.LOG(LogLevel.DEBUG, LogLevel.DEBUG, "AVAudioSessionWrapper", "StopRecording");
            }
#endif
        }
