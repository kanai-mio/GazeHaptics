...
namespace AudioStream
{
    ...
    /// </summary>
    public class AudioSourceOutputDevice : ABase
    {
        // ========================================================================================================================================
        #region Editor
        [Header("[Setup]")]
        ...
        /// </summary>
        public FMOD_SystemW.OUTPUT_DEVICE_INFO outputDevice { get; protected set; }
        ...
        /// </summary>
        public FMOD_SystemW.OUTPUT_DEVICE_INFO runtimeOutputDevice { get; protected set; }
        ...
        protected virtual void StartFMODSoundAndSystem(int onOutputDriverID, bool rememberOutput)
        {
            ...
            (this.sound, this.channel) = this.outputdevice_system.CreateAndPlaySound(unitySampleRate, unityChannels, this.inputLatency, this.logLevel, this.gameObjectName, this.OnError);
        ...
        public void ReflectOutput_Finish(List<FMOD_SystemW.OUTPUT_DEVICE_INFO> updatedOutputDevices)
        {
