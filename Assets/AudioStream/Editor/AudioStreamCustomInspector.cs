...
{
    [CustomEditor(typeof(ABase), true)]
    ...
    public class AudioStreamCustomInspector : Editor
    {
        ...
        void SetFieldCondition()
        {
            ...
            else if (target is AudioStreamInputBase)
            {
                // the reflection system cares only about the final enum member name
            ...
            if (obj.NextVisible(true))
            {
                ...
                do
                {
                    ...
                    if (serializedObject.targetObject.GetType() == typeof(ResonanceSource)
                        || serializedObject.targetObject.GetType() == typeof(AudioStreamListenerAudioSource)
                        || serializedObject.targetObject.GetType() == typeof(ResonanceInput)
                        )
                    {
